...
// NOTE: [Barkley] This is giving a compilation error. I've checked online and it looks like a new version of openFrameworks solve the issue but I can't integrate it right now
//EXTERN_API( OSErr )
